    ...
    public class ReservaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Reserva != null ? 
                          ...
                          Problem("Entity set 'RestaurantDatabaseContext.Reserva'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,CantidadDePersonas")] Reserva reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CantidadDePersonas")] Reserva reserva)
        {
            if (id != reserva.ID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantDatabaseContext.Reserva'  is null.");
            }
            var reserva = await _context.Reserva.FindAsync(id);
            if (reserva != null)
            {
